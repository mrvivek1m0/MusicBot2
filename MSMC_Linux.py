...
def Load():
    global Combos, fname
    print(Fore.LIGHTBLUE_EX+"Enter the path to your combo file (e.g., combos.txt):")
    ...
    try:
        with open(file_path, 'r', encoding='utf-8', errors='ignore') as e:
            ...
            fname = os.path.splitext(os.path.basename(file_path))[0] # Get filename without extension
